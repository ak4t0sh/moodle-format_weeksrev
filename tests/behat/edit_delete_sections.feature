@format @format_weeksrev
Feature: Sections can be edited and deleted in weeksrev format
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Course 1 | C1        | weeksrev  | 0             | 5           | 957139200 |
  ...
  @javascript
  Scenario: Inline edit section name in weeksrev format
  ...
  Scenario: Deleting the last section in weeksrev format
  ...
  Scenario: Deleting the middle section in weeksrev format
    Given I should see "29 May - 4 June" in the "li#section-5" "css_element"
  ...
  @javascript
  Scenario: Adding sections in weeksrev format
